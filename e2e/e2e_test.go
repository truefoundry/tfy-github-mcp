...
func TestPullRequestAtomicCreateAndSubmit(t *testing.T) {
	...
	createAndSubmitReviewRequest.Params.Name = "submit_pull_request_review"
	...
	require.NoError(t, err, "expected to call 'submit_pull_request_review' tool successfully")
	require.False(t, resp.IsError, fmt.Sprintf("expected result not to be an error: %+v", resp))
...
func TestPullRequestReviewCommentSubmit(t *testing.T) {
	...
	addFileReviewCommentRequest.Params.Name = "add_review_comment_to_pending_review"
	...
	require.NoError(t, err, "expected to call 'add_review_comment_to_pending_review' tool successfully")
	require.False(t, resp.IsError, fmt.Sprintf("expected result not to be an error: %+v", resp))

	// Add a single line review comment
	addSingleLineReviewCommentRequest := mcp.CallToolRequest{}
	addSingleLineReviewCommentRequest.Params.Name = "add_review_comment_to_pending_review"
	...
	addMultilineReviewCommentRequest.Params.Name = "add_review_comment_to_pending_review"
